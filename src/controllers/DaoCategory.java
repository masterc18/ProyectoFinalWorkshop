...
public class DaoCategory {
    ...
    public DaoCategory() {
        try {
            ...
            selectAllCategory = conn.prepareStatement("SELECT Categories.* FROM Categories");
            selectCategoryById = conn.prepareStatement("SELECT Categories.* FROM Categories where IDCategory = ?");
            selectCategoryByName = conn.prepareStatement("SELECT Categories.* FROM Categories where NameCategory like ?");
    ...
    /**
     * Llena un arrayList con todos los registros de la
     * tabla Categories
     */
